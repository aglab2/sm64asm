...
#define SURFACE_IS_UNSAFE(cmd)                  (((cmd) == SURFACE_BURNING) || SURFACE_IS_QUICKSAND(cmd) || SURFACE_IS_WARP(cmd) || ((cmd) == SURFACE_DEATH_PLANE) || ((cmd) == SURFACE_NOISE_DEFAULT) || ((cmd) == SURFACE_SLIPPERY) || ((cmd) == SURFACE_HORIZONTAL_WIND))
